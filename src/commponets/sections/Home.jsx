                ...
                <div>
                    <div className="text-center z-10 px-4">
                        ...
                        <div className="flex justify-center space-x-4">
                            <a href="#projects" className="bg-blue-500 text-white py-3 px-6 rounded font-medium transition relative overflow-hidden hover:-translate-y-0.5 hover:drop-shadow-[0_0_6px_rgba(0,191,255,0.7)]">
                                View Projects
                            </a>
